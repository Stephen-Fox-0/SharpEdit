...
namespace SharpEdit.Helpers
{
    ...
    class MaterialTheme: ThemeContainer154
    {
        ...
        {
            G.Clear (Color.White);
            G.FillRectangle (new SolidBrush (ColorTranslator.FromHtml ("233,233,233")) , new Rectangle (0 , 0 , this.Width-1 , 35));
            G.DrawRectangle (new Pen (ColorTranslator.FromHtml ("156,156,156")) , new Rectangle (0 , 0 , this.Width-1 , this.Height-1));
            G.DrawString (
                this.Text ,
                new Font ("Segoe UI Light" , 10) ,
                new SolidBrush (Color.FromArgb (156 , 156 , 156)) ,
                new Rectangle (20, 0 , this.Width-1 , 35) ,
                new StringFormat ()
                {
